...
def try_methods():
    ...
    ###########################################################################
    lawnmower = rg.SimpleTurtle('circle')
    lawnmower.pen = rg.Pen('brown',5)
    lawnmower.forward(150)
    lawnmower.left(90)
    lawnmower.forward(50)
    lawnmower.backward(100)
...
def try_methods_and_functions():
    ...
    """
    gorbachev = rg.SimpleTurtle()
    gorbachev.pen = rg.Pen('blue', 5)
    gorbachev.backward(150)
    gorbachev.speed = 1
    draw_many_squares(gorbachev, 2, 100, 30)
    gorbachev.speed = 5
    gorbachev.pen = rg.Pen('red', 5)
    draw_many_squares(gorbachev, 10, 50, 15)
    gorbachev.speed = 100
    gorbachev.pen = rg.Pen('red', 35)
    draw_many_squares(gorbachev, 8, 300, 60)
    gorbachev.pen = rg.Pen('black', 3)
    gorbachev.backward(200)
    gorbachev.draw_circle(30)
    gorbachev.draw_square(50)
